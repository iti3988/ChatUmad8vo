    ...
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Teachers != null ? 
                          ...
                          Problem("Entity set 'DataContext.Teachers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] Teacher teacher)
        {
            if (id != teacher.Id)
            {
                return NotFound();
