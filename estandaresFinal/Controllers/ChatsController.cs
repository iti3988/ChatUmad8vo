    ...
    public class ChatsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Chats != null ? 
                          ...
                          Problem("Entity set 'DataContext.Chats'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Date")] Chat chat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date")] Chat chat)
        {
            if (id != chat.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataContext.Chats'  is null.");
            }
            var chat = await _context.Chats.FindAsync(id);
            if (chat != null)
            {
